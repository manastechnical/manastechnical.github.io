    ...
    return (
        <div className='flex-1 w-full h-full flex-col pt-24 4xl:pt-2 lg:flex-row flex justify-center items-center'>
            ...
            <motion.div className='flex-1 h-full flex justify-end items-end relative' whileInView={{ opacity: [0, 1] }} transition={{ duration: 0.5, delayChildre: 0.5 }}>
                <img className='w-full h-full object-contain z-1' src={profile} alt="img" />
                <motion.img whileInView={{ scale: [0, 1] }} transition={{ duration: 1, ease: 'easeInOut' }} className="absolute left-0 right-0 bottom-0 z-0 w-full h-[90%] my-8 mx-0 lg:my-0" src={circle} alt='profile' />
            </motion.div>
