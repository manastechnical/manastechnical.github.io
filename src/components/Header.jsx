    ...
    return (
        <nav className='flex w-full justify-between items-center py-4 px-8 bg-white/20 backdrop-blur-sm -webkit-backdrop-blur-sm fixed border-2 border-solid border-white/10 z-10'>
            <div className='flex justify-start items-center'>
                ...
                {/* <div className=' text-3xl font-extrabold text-gray-700'>MANAS</div> */}
            </div>
            ...
            <div className='md:hidden w-9 h-9 rounded-[50%] relative flex justify-center items-center bg-blue-800'>
                ...
                {toggle && (
                    <motion.div className='fixed top-0 bottom-0 right-0 z-10 p-4 w-[80%] h-screen flex justify-end items-end flex-col bg-white bg-repeat bg-[url("../assets/bgWhite.png")] bg-cover shadow-md' whileInView={{ x: [300, 0] }} transition={{ duration: 0.85, ease: 'easeOut' }}>
